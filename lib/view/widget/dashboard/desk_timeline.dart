...
import 'package:timeline/service/usercomplaints.dart';
...
class _TimelineComponentState extends State<TimelineComponent> {
  ...
  void initState() {
    ...
    response = [];
    UserComplaints.getComplaints().then((value) {
      setState(() {
        response = value;
        isLoading = false;
      });
  ...
  Widget build(BuildContext context) {
    ...
    // var lastComplaintId = response.toList();
    // print(lastComplaintId);
                  ...
                  child: Column(
                    ...
                    children: [
                      ListTile(
                        ...
                        leading: Image.asset("assets/img/civil.png"),
