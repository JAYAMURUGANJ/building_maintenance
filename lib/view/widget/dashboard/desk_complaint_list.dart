...
import 'package:timeline/model/complaint.dart';
...
class DeskComplaintListState extends State<DeskComplaintList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: Constants.isMobile(context) == false
          ? EdgeInsets.only(left: mediaWidth / 40, right: mediaWidth / 30)
      ...
      child: LimitedBox(
        ...
        maxHeight: Constants.isDesktop(context) == true
            ? mediaWidth / 8
              ...
              children: [
                Row(
                  ...
                  children: [
                    SizedBox(
                      width:
                          Constants.isDesktop(context) == true ? 100.0 : 80.0,
                      height: Constants.isTablet(context) == true ? 80.0 : 60,
                      child: Image.asset(
                        imgUrl,
                      ),
                    ),
